...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    //NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CFUDID" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Rest.sqlite"];
