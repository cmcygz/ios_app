...
#define kCancelButtonHeight   30.0
...
-(void)show
{
	...
	UIImageView *alertBgImage = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"AlertButton.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:30]];
	...
	UIImageView *maskShadow = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:7]];
